...
function webViewerLoad() {
  ...
  if (typeof PDFJSDev === 'undefined' || !PDFJSDev.test('PRODUCTION')) {
    Promise.all([
      // System.import('pdfjs-web/app'),
      // System.import('pdfjs-web/app_options'),
      // System.import('pdfjs-web/genericcom'),
      // System.import('pdfjs-web/pdf_print_service'),
        require('./app'),
        require('./app_options'),
        require('./genericcom'),
        require('./pdf_print_service')
